...
export default function Content() {
  const products = [
    ...
    },
    {
      ...
      description:
        "ქართული სამზარეულოს კლასიკური კერძი, დამზადებული თხელი ცომისგან, რომელიც შიგნით შეიცავს ხორცის წვნიან ფარშს. მთიულური ხინკალი გამოირჩევა სიმსუბუქით და ხორცის მრავალფეროვანი არომატით.",
